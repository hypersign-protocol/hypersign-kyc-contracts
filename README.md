...
- [x] Implement request did-auth for issuer did in onchain-kyc page in dashboard during onchain kyc deployment step
...
- [x] Integrate facefi API backend
...
- :heavy_check_mark: Update ver-keys for all other proofs
